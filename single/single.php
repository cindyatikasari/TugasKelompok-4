		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="services.hphp">Services</a><i>/</i></li>
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>Rp21.000 <span>Rp25.000</span></h4>
						</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rp2.000 <span>Rp3.000</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rp6.000 <span>Rp8.000</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rp3.000 <span>Rp4.000</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rp4.000 <span>Rp5.000</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
	...
	<div class="footer">
		<div class="container">
				...
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						...
						<ul class="agileits_social_icons">
							<li><a href="https://id-id.facebook.com/" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
							<li><a href="https://twitter.com/login" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							<li><a href="https://www.google.co.uk/" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
			...
			<div class="wthree_footer_copy">
				<p>© 2017 | 5 in 1 Delivery | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
