...
<body style="background:url(background.jpg);color:#1E90FF">
<body>
  <table border="5" bgcolor="A9C5EB" align="center" height="500" width="400" cellpadding="20">
  <tr>
  <td>
  <font color="blue" size="10"> Sign Up </font>
   <p> It's free and always will be </p>
	...
	<input type="password" Name="sandi" size="46" placeholder="Masukan Ulang Kata Sandi"><br>
   ...
   <p><b> Status </b></p>
    ...
    <br><br><br>
	<center><input value="Create Account" style="background-color:#1E90FF; height: 100; width: 200;"type="submit"></center>
</td>
</tr>
